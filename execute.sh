...
#./run-sniper -c nehalem-lite -sprogresstrace -s stop-by-icount:100000000 --pinballs=pinballs/mcf/pinball
#cat sim.out  > simout/$predictor/mcfout.txt 
./run-sniper -c nehalem-lite -sprogresstrace -s stop-by-icount:100000000 --pinballs=pinballs/bzip2/pinball
